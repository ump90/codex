...
pub use invocation::verify_apply_patch_args_with_mode_and_path_syntax;
...
pub async fn apply_patch_with_options(
    ...
    apply_patch_with_options_and_path_syntax(
        patch,
        options,
        ApplyPatchPathSyntax::Native,
        cwd,
...
pub async fn apply_patch_with_options_and_path_syntax(
    patch: &str,
    options: ApplyPatchOptions,
    path_syntax: ApplyPatchPathSyntax,
    cwd: &PathUri,
    ...
    apply_hunks_with_options_and_path_syntax(
        &hunks,
        options,
        path_syntax,
        cwd,
...
async fn apply_hunks_with_options_and_path_syntax(
    hunks: &[Hunk],
    options: ApplyPatchOptions,
    path_syntax: ApplyPatchPathSyntax,
    cwd: &PathUri,
    ...
    match apply_hunks_to_files(hunks, options, cwd, path_syntax, fs, sandbox, &mut delta).await {
        Ok(affected_paths) => {
